...
import { SimpleXml, XmlSchema } from './Serialize.XML.Types'
...
export class BomNormalizer extends Base {
  normalize (data: Bom, options: NormalizerOptions): SimpleXml.Element {
...
export class MetadataNormalizer extends Base {
  normalize (data: Metadata, options: NormalizerOptions, elementName: string): SimpleXml.Element {
...
export class ToolNormalizer extends Base {
  normalize (data: Tool, options: NormalizerOptions, elementName: string): SimpleXml.Element {
  ...
  normalizeIter (data: Iterable<Tool>, options: NormalizerOptions, elementName: string): SimpleXml.Element[] {
...
export class HashNormalizer extends Base {
  normalize ([algorithm, content]: Hash, options: NormalizerOptions, elementName: string): SimpleXml.Element | undefined {
  ...
  normalizeIter (data: Iterable<Hash>, options: NormalizerOptions, elementName: string): SimpleXml.Element[] {
...
export class OrganizationalContactNormalizer extends Base {
  normalize (data: OrganizationalContact, options: NormalizerOptions, elementName: string): SimpleXml.Element {
    return {
      type: 'element',
      name: elementName,
      children: [
  ...
  normalizeIter (data: Iterable<OrganizationalContact>, options: NormalizerOptions, elementName: string): SimpleXml.Element[] {
...
export class OrganizationalEntityNormalizer extends Base {
  normalize (data: OrganizationalEntity, options: NormalizerOptions, elementName: string): SimpleXml.Element {
    return {
      type: 'element',
      name: elementName,
      children: [
...
export class ComponentNormalizer extends Base {
  normalize (data: Component, options: NormalizerOptions, elementName: string): SimpleXml.Element | undefined {
  ...
  normalizeIter (data: Iterable<Component>, options: NormalizerOptions, elementName: string): SimpleXml.Element[] {
...
export class LicenseNormalizer extends Base {
  normalize (data: License, options: NormalizerOptions): SimpleXml.Element {
    switch (true) {
  ...
  #normalizeNamedLicense (data: NamedLicense, options: NormalizerOptions): SimpleXml.Element {
  ...
  #normalizeSpdxLicense (data: SpdxLicense, options: NormalizerOptions): SimpleXml.Element {
    const url = data.url?.toString()
    return {
      type: 'element',
      name: 'license',
  ...
  #normalizeLicenseExpression (data: LicenseExpression): SimpleXml.Element {
    return makeTextElement(data.expression, 'expression')
  }

  normalizeIter (data: LicenseRepository, options: NormalizerOptions): SimpleXml.Element[] {
...
export class SWIDNormalizer extends Base {
  normalize (data: SWID, options: NormalizerOptions, elementName: string): SimpleXml.Element {
    const url = data.url?.toString()
    return {
      type: 'element',
      name: elementName,
...
export class ExternalReferenceNormalizer extends Base {
  normalize (data: ExternalReference, options: NormalizerOptions, elementName: string): SimpleXml.Element | undefined {
    const url = data.url.toString()
  ...
  normalizeIter (data: Iterable<ExternalReference>, options: NormalizerOptions, elementName: string): SimpleXml.Element[] {
    const references = Array.from(data)
    if (options.sortLists ?? false) {
      references.sort(ExternalReferenceRepository.compareItems)
    }
...
export class AttachmentNormalizer extends Base {
  normalize (data: Attachment, options: NormalizerOptions, elementName: string): SimpleXml.Element {
    return {
      type: 'element',
      name: elementName,
      attributes: {
...
export class DependencyGraphNormalizer extends Base {
  normalize (data: Bom, options: NormalizerOptions, elementName: string): SimpleXml.Element | undefined {
